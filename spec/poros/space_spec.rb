...
RSpec.describe Space do
  before(:each) do
    my_space = { id: "90090228842",
                 ...
                 statuses: [{ id: "p90090228842_u4kv1Iu6", status: "Open", type: "open", orderindex: 0, color: "#d3d3d3" },
                            { id: "p90090228842_ed7ZhKIM", status: "in progress", type: "custom", orderindex: 1,
                              color: "#81B1FF" },
                            { id: "p90090228842_sgP0Eljz", status: "roadblock", type: "custom", orderindex: 2,
                              color: "#f9d900" },
                            { id: "p90090228842_VYrFKFQ1", status: "complete", type: "closed", orderindex: 3,
                              color: "#6bc950" }],
                 ...
                 features: { due_dates: { enabled: true, start_date: true, remap_due_dates: true, remap_closed_due_date: false },
                             ...
                             priorities: { enabled: true,
                                           priorities: [{ color: "#f50000", id: "1", orderindex: "1", priority: "urgent" },
                                                        { color: "#ffcc00", id: "2", orderindex: "2",
                                                          priority: "high" },
                                                        { color: "#6fddff", id: "3", orderindex: "3",
                                                          priority: "normal" },
                                                        { color: "#d8d8d8", id: "4", orderindex: "4",
                                                          priority: "low" }] },
                             tags: { enabled: true },
                             ...
                             emails: { enabled: true } },
                 archived: false,
                 members: [{ user: { id: 66_176_739, username: "Christopher Crane", color: "#d60800",
  ...
  it "exists" do
    ...
    expect(@space.members.first.id).to eq(66_176_739)
  end
